...
//modify@zte.com.cn at 20160530 begin
...
extern char g_ctp_id_str[21];
 ...
 u16 Minor = 0;
#endif
//modify@zte.com.cn at 20160530 end
...
//modify@zte.com.cn at 20160525 begin
#ifdef CONFIG_WIND_DEVICE_INFO
 if (g_ChipType == CHIP_TYPE_MSG26XXM)
 	sprintf(g_ctp_id_str,"MSG26XXM");
 else if(g_ChipType == CHIP_TYPE_MSG28XX)
	sprintf(g_ctp_id_str,"CHIP_TYPE_MSG28XX");
 else if(g_ChipType == CHIP_TYPE_MSG21XXA)
	sprintf(g_ctp_id_str,"CHIP_TYPE_MSG21XXA");
 else if(g_ChipType == CHIP_TYPE_MSG22XX)
	sprintf(g_ctp_id_str,"CHIP_TYPE_MSG22XX");
    
	 DrvIcFwLyrGetCustomerFirmwareVersion(&Major, &Minor, &_gFwVersion);
	g_ctp_vendor=Major;
	g_ctp_fwvr=Minor;
#endif
//modify@zte.com.cn at 20160525 end

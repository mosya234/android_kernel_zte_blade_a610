...
* Static variables
*******************************************************************************/
// extern u16 g_ctp_vendor; //modify@zte.com.cn remove at 20160410
//modify@zte.com.cn modify at 20160414 begin
static unsigned char CTPM_FW[] = {
	...
	//#include "YD_E187_FT3427_BY0XA6_V09_D07_20160429_app.i" //modify@zte.com.cn modify at 20160505
	//#include "YD_E188_FT3427_BY0XA6_V0d_D07_20160530_app.i"//modify@zte.com.cn modify 20160603
	#include "YD_E188_FT3427_BY0XA6_V0e_D07_20160613_app.i"//modify@zte.com.cn modify 20160615
};
static unsigned char CTPM_FW1[] = {
	#include "FT5x46i_FT34x7_V05_D0A_20160428_app.i" //modify@zte.com.cn modify at 20160503
};
static unsigned char CTPM_FW2[] = {
	//#include "YD_E187_YS0Xb5_V16_D07_20160810_app.i" //modify@zte.com.cn modify at 20160811
	//#include "YD_E188_YS0Xa7_V17_D07_20160824_app.i"  //modify@zte.com.cn modify at 20160825
	#include "YDE188_FT3427_YSID0xA7_ver0x18_V18_D07_20160929_app.i"//liujinzhou@wind.com modify at 20160929
};
...
int fts_5x36_ctpm_fw_upgrade(struct i2c_client *client, u8 *pbt_buf, u32 dw_lenth)
{
	...
	int	fw_filenth1 = sizeof(CTPM_FW1); //modify@zte.com.cn add at 20160504
	int	fw_filenth2 = sizeof(CTPM_FW2);//modify@zte.com.cn 20160819
	if((CTPM_FW[fw_filenth-12] == 30) || (CTPM_FW1[fw_filenth1-12] == 30) || (CTPM_FW2[fw_filenth2-12] == 30)) //modify@zte.com.cn modify at 20160504   modify@zte.com.cn 20160819
	{
		is_5336_fwsize_30 = 1;
	}
	else 
...
{
	//modify@zte.com.cn add at 20150504 begin
	u16 ui_sz,ui_sz1,ui_sz2;//modify@zte.com.cn 20160819
	int fw_id = 0;  //modify@zte.com.cn 20160825
	ui_sz = sizeof(CTPM_FW);
	ui_sz1 = sizeof(CTPM_FW1); 
	ui_sz2 = sizeof(CTPM_FW2); //modify@zte.com.cn 20160819

		if(tp_vendor_id==0xA6)
		{
			fw_id = CTPM_FW[ui_sz - 2];
		}
		else if (tp_vendor_id==0xA7)  //modify@zte.com.cn 20160825
		{
			fw_id = CTPM_FW2[ui_sz2 - 2];//modify@zte.com.cn 20160819
		}
		else if (tp_vendor_id==0x8D)  //modify@zte.com.cn 20160825
		{
	...
	//modify@zte.com.cn add at 20150504 end
	return 0x00;
}
/************************************************************************
...
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	//modify@zte.com.cn add at 20150410 begin
	int fw_len1 = sizeof(CTPM_FW1);
	int fw_len2 = sizeof(CTPM_FW2);//modify@zte.com.cn 20160819
	u8  tp_vendor_id;
	fts_read_reg(client, FTS_REG_VENDOR_ID, &tp_vendor_id);
	//modify@zte.com.cn add at 20150410 end
	...
	*/
	...
	{
	//modify@zte.com.cn modify at 20160506 begin
		if(tp_vendor_id==0xA6)
		{
		...
		//modify@zte.com.cn 20160819 start
		else if(tp_vendor_id==0xA7)  //modify@zte.com.cn 20160825
		{
			printk("twz vendor_name=FT3427 \n");
		...
		//modify@zte.com.cn 20160819 end
		else if(tp_vendor_id==0x8D)  //modify@zte.com.cn 20160825
		{
		...
		//modify@zte.com.cn modify at 20160506 end
	}	
	else if ((fts_updateinfo_curr.CHIP_ID==0x58))
	{
		if (fw_len < 8 || fw_len > 54*1024) 
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	if((uc_tp_vendor_id != FTS_Vendor_1_ID) && (uc_tp_vendor_id != FTS_Vendor_2_ID)&& (uc_tp_vendor_id != FTS_Vendor_3_ID))//modify@zte.com.cn 20160811 add FTS_Vendor_3_ID 
	{
		uc_boot_vendor_id = ft5x46_ctpm_VidFWid_get_from_boot(client);
		printk("[FTS] uc_boot_vendor_id= 0x%x!\n", uc_boot_vendor_id);
		if((uc_boot_vendor_id == FTS_Vendor_1_ID)|| (uc_boot_vendor_id == FTS_Vendor_2_ID)|| (uc_boot_vendor_id == FTS_Vendor_3_ID))//modify@zte.com.cn 20160811 add FTS_Vendor_3_ID
		{
	...
	uc_host_fm_ver = fts_ctpm_get_i_file_ver(uc_tp_vendor_id); //modify@zte.com.cn modify at 20160506
	...
	if (uc_tp_fm_ver == FTS_REG_FW_VER ||	uc_tp_fm_ver < uc_host_fm_ver )
	{
		...
		{
			msleep(300);
			uc_host_fm_ver = fts_ctpm_get_i_file_ver(uc_tp_vendor_id); //modify@zte.com.cn modify at 20160504
...
//modify@zte.com.cn add at 20160311 end
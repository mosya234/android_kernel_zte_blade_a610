...
//modify@zte.com.cn 20160317 begin
#define HX_CHIP_STATUS_MONITOR		//for ESD 2nd solution,default off
//modify@zte.com.cn 20160317 end
...
#define GEST_PT_MAX_NUM     (128)
	...
	//modify by modify@zte.com.cn 2016-01-29 begin
	#define KEY_CUST_01 0xFFF
	#define KEY_CUST_02 0xFFF
	#define KEY_CUST_03 192
	#define KEY_CUST_04 193
	#define KEY_CUST_05 183  //C
	#define KEY_CUST_06 0xFFF
	#define KEY_CUST_07 187   //M
	#define KEY_CUST_08 186   //O
	#define KEY_CUST_09 0xFFF
	#define KEY_CUST_10 0xFFF
	#define KEY_CUST_11 185   //W
	#define KEY_CUST_12 0xFFF
	#define KEY_CUST_13 0xFFF
	#define KEY_CUST_14 0xFFF
	#define KEY_CUST_15 0xFFF
	//modify by modify@zte.com.cn 2016-01-29 end

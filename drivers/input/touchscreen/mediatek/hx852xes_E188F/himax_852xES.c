/*modify@zte.com.cn 20160831 begin*/
...
static u8 g_proximity_en = 0;
	...
	//modify@zte.com.cn 20160510 begin
		//#include "E180_CID270F_C11_20160122.i"
		//#include "E180_E411_CID2714_C14_v2_20160229.i"
		//#include "TXD_E1831_E411_C1A_2016-04-20.i"
		//#include "ZTE_E180_E411_CID2608_20160428_C31.i"
		//#include "TXD_E1831_E411_C32_2016-05-10.i"		
	      //#include "TXD_CT500C-84A_E187_C06_2016-06-08.i"
		//#include "TXD_CT500C-84A_E187_C11_2016-06-27.i"//modify@zte.com.cn 20160629
		//#include "TXD_CT500C-84A_E187_C16_2016-07-12_1915.i"//modify@zte.com.cn 20160721
		//#include "TXD_CT500C-84A_E187_C26_2016-08-25.i"  //modify@zte.com.cn 20160831
		#include "TXD_CT500C-84A_E187_C28_2016-09-02_2227.i"  //modify@zte.com.cn 20160903
	//modify@zte.com.cn 20160510 end
	};
#endif
...
static int himax_input_register(struct himax_ts_data *ts)
{
	...
	//modify@zte.com.cn 20160319 begin
	set_bit(191, ts->input_dev->keybit);
	//modify@zte.com.cn 20160319 end
#endif	
...
void himax_touch_information(void)
{
	...
	I("%s:IC_TYPE =%d\n", __func__,IC_TYPE);
	//modify@zte.com.cn 20160513 begin
	if(IC_TYPE == HX_85XX_ES_SERIES_PWON)
	    //if(0)
	//modify@zte.com.cn 20160513 end
		{
	  		data[0] = 0x8C;
	  		data[1] = 0x14;
...
//modify@zte.com.cn 20160427 begin
#if defined(HX_USB_DETECT2)
		ts->usb_connected = 0;
#endif
//modify@zte.com.cn 20160427 end
...
//							100);
					...
					input_report_key(ts->input_dev, KEY_MENU, 1);//modify@zte.com.cn modify  20151217 #92975
		}
...
#endif
//modify@zte.com.cn 20160418 start
#if defined(HX_USB_DETECT2)
	himax_cable_detect_func();
#endif
//modify@zte.com.cn 20160418 end
#ifdef HX_CHIP_STATUS_MONITOR
		HX_CHIP_POLLING_COUNT=0;
	...
	do
	{
		...
		if (private_ts->debug_log_level & BIT(2)) {
			...
			if (atomic_read(&private_ts->suspend_mode)&&(!FAKE_POWER_KEY_SEND)&&(private_ts->SMWP_enable)) {
				...
				switch (ret_event) {
					//modify by modify@zte.com.cn 2016-02-29 begin
					case EV_GESTURE_PWR:
						KEY_EVENT = 191;
					break;
					//modify by modify@zte.com.cn 2016-02-29 end
					case EV_GESTURE_01:
...
static void himax_cable_detect_func(void)
{
	...
	//connect_status = 0;
	//modify@zte.com.cn 0160418 start
...
static int himax_chip_self_test(void)
{
	...
	uint8_t valuebuf[16];
	//modify@zte.com.cn 20160513 begin
	int i=0, pf_value=0x00,self_test_loop_counter=0;
	//modify@zte.com.cn 20160513 end
...
read_result_again:
	...
	//modify@zte.com.cn 20160513 begin
		self_test_loop_counter++;
		if( self_test_loop_counter < 0x64 )
	//modify@zte.com.cn 20160513 end
	...
	size_t len, loff_t *pos)
{
    ...
    //modify by modify@zte.com.cn for 103482 2016-03-29 begin
	//#ifdef HX_RST_PIN_FUNC
			//himax_HW_reset(true,false);
	//#endif
	//modify by modify@zte.com.cn for 103482 2016-03-29 end
...
{	
	...
	struct himax_ts_data *ts;
	struct himax_i2c_platform_data *pdata;
	//modify@zte.com.cn at 20160415 begin
	char data[12] = {0};
	//modify@zte.com.cn at 20160415 end
...
//modify@zte.com.cn at 20160415 begin
	...
	//Get fw version
	g_ctp_fwvr = private_ts->vendor_fw_ver_H << 8 | private_ts->vendor_fw_ver_L;
	//Get config version
	g_ctp_vendor = private_ts->vendor_config_ver;
#endif	
//modify@zte.com.cn at 20160415 end
...
#endif
#ifdef HX_SMART_WAKEUP
//liupeng add  default enable SMWP func start
/*
...
#endif
*/
//liupeng add  default enable SMWP func  end
...
#endif
//modify@zte.com.cn 20160505 start
//#if defined(HX_USB_DETECT2)
//	himax_cable_detect_func();
//#endif
//modify@zte.com.cn 20160505 end
#ifdef HX_SMART_WAKEUP
	if(ts->SMWP_enable)
	{
		//Sense Off
...
MODULE_LICENSE("GPL");
/*modify@zte.com.cn 20160831 end*/

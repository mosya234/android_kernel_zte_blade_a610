...
#define CTP_ESD_PROTECT							1 //modify@zte.com.cn add at 20160602
/*********************Custom Define end*************************************************/
...
#define SYSFS_DEBUG
//#define TPD_AUTO_UPGRADE  //modify@zte.com.cn add 20160408
#define MTK_CTP_NODE                     1
//modify@zte.com.cn 20160419 begin
#define USB_CHARGE_DETECT		 1 
//modify@zte.com.cn 20160419 end

#ifdef TPD_AUTO_UPGRADE
#define Boot_Upgrade_Protect			//开机升级保护。升级失败后，再次开机可重新升级
#endif
#define FTS_CHIP_ID			0x12	//FT3427、FT5x46 CHIP ID = 0x54 FT5436i chip id = 0x12
//modify@zte.com.cn modify at 20160506 begin
#define FTS_Vendor_1_ID		0x79//Ofilm TP VID = 0x51   FT3427 VID == 0xA6 ft5436i vid = 0x79
...
extern int fts_ctpm_get_i_file_ver(u8 tp_vendor_id); //modify@zte.com.cn modify at 20160506

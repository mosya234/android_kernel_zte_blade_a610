...
static unsigned char CTPM_FW[] = {
	...
	#include "FT5436I_E163_E169_Each_V0x0a_20151222_app.i" //modify@zte.com.cn modify at 20160505
};
...
int fts_5x36_ctpm_fw_upgrade(struct i2c_client *client, u8 *pbt_buf, u32 dw_lenth)
{
	...
	if((CTPM_FW[fw_filenth-12] == 30) || (CTPM_FW1[fw_filenth1-12] == 30)) //modify@zte.com.cn modify at 20160504
	{
		is_5336_fwsize_30 = 1;
	}
	else 

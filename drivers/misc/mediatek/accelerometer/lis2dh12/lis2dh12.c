...
//modify@zte.com.cn add at 20160315 end
...
//tuwenzan
//static struct i2c_board_info __initdata i2c_LIS2DH12={ I2C_BOARD_INFO("LIS2DH12", (0x32>>1))};
...
//modify@zte.com.cn add at 20160315 begin
/* Maintain  cust info here */
struct acc_hw accel_cust2; //liupeng
static struct acc_hw *hw = &accel_cust2; //liupeng

/* For  driver get cust info */
struct acc_hw *get_cust_acc2(void) { //liupeng
    return &accel_cust2; //liupeng
}
//modify@zte.com.cn add at 20160315 end
...
#if defined(CONFIG_LIS2DH12_LOWPASS)
    atomic_t                firlen;
    atomic_t                fir_en;
...
//modify@zte.com.cn 20160401 begin
#ifdef CONFIG_WIND_DEF_PRO_E183L
	{.compatible = "mediatek,mhl"},
#else
	{.compatible = "mediatek,gsensor"},
#endif
//modify@zte.com.cn 20160401 end
	{},
};
...
static int LIS2DH12_SetDataResolution(struct lis2dh12_i2c_data *obj)
{
	...
	if((err = lis_i2c_read_block(obj->client, LIS2DH12_REG_CTL_REG4, &dat,0x01))<0)
	{
...
static int LIS2DH12_ReadData(struct i2c_client *client, s16 data[LIS2DH12_AXES_NUM])
{
	...
	{
		if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_X, buf, 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }
		if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_X+1, &buf[1], 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }
	...
	if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_Y, &buf[2], 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }
	if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_Y+1, &buf[3], 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }
	...
	if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_Z, &buf[4], 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }

	if((lis_i2c_read_block(client, LIS2DH12_REG_OUT_Z+1, &buf[5], 0x01))<0)
	    {
		   GSE_ERR("read  G sensor data register err!\n");
		     return -1;
	    }
...
static int LIS2DH12_SetPowerMode(struct i2c_client *client, bool enable)
{
	...
	res = lis_i2c_write_block(client, LIS2DH12_REG_CTL_REG1, databuf, 0x1);
...
static int LIS2DH12_SetDataFormat(struct i2c_client *client, u8 dataformat)
{
	...
	res = lis_i2c_write_block(client, LIS2DH12_REG_CTL_REG4, databuf, 0x1);
...
static int LIS2DH12_SetIntEnable(struct i2c_client *client, u8 intenable)
{
	...
	res = lis_i2c_write_block(client, LIS2DH12_REG_CTL_REG3, databuf, 0x01);
	if(res < 0)
	{
		return LIS2DH12_ERR_I2C;
	}
...
*/	
    ...
    res = lis_i2c_write_block(client, LIS2DH12_REG_CTL_REG1, databuf, 0x01);
	if(res < 0)
	{
    ...
    res = lis_i2c_write_block(client, LIS2DH12_REG_CTL_REG4, databuf, 0x01);
	if(res < 0)
	{
		GSE_ERR("LIS2DH12_Init step 1!\n");
		return res;
...
static int LIS2DH12_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	else
	{
		...
		//Out put the mg
		acc[LIS2DH12_AXIS_X] = acc[LIS2DH12_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		acc[LIS2DH12_AXIS_Y] = acc[LIS2DH12_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		acc[LIS2DH12_AXIS_Z] = acc[LIS2DH12_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
...
static ssize_t show_power_status(struct device_driver *ddri, char *buf)
{
	...
	obj = i2c_get_clientdata(client);
	lis_i2c_read_block(client,LIS2DH12_REG_CTL_REG1,&data,0x01);
...
static int  lis2dh12_remove(void)
{
//twz    struct acc_hw *hw = lis2dh12_get_cust_acc_hw();
...
//twz	i2c_register_board_info(hw->i2c_num, &i2c_LIS2DH12, 1);

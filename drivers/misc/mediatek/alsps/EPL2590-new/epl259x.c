//modify@zte.com.cn add at 20160115 begin
...
//modify@zte.com.cn 20160426 start
//#define LUX_PER_COUNT	400  //ALS lux per count
#define LUX_PER_COUNT	150  //ALS lux per count //modify@zte.com.cn 20160512 modif 150->65
//modify@zte.com.cn 20160426 end
/*ALS interrupt table*/
...
static void initial_global_variable(struct i2c_client *client, struct epl_sensor_priv *obj)
{
    ...
    //modify@zte.com.cn 20160426 start
   // epl_sensor.als.report_type = CMC_BIT_RAW; //CMC_BIT_DYN_INT;//CMC_BIT_PRE_COUNT
    epl_sensor.als.report_type = CMC_BIT_PRE_COUNT; //CMC_BIT_DYN_INT;//CMC_BIT_RAW
   //modify@zte.com.cn 20160426 end
    ...
    epl_sensor.ps.integration_time = EPL_PS_INTT_272;//modify@zte.com.cn 20160514 modify EPL_PS_INTT_272--->EPL_PS_INTT_520;
	...
	//modify@zte.com.cn modify at 20160408 begin
#if PS_DYN_K
    dynk_max_ir_data = 50000; // ps max ch0
//modify@zte.com.cn 20160514 start
    dynk_low_offset = 230; //500
    dynk_high_offset = 470; //800
//modify@zte.com.cn 20160514 end
#endif /*PS_DYN_K*/
	//modify@zte.com.cn modify at 20160408 end
#if HS_ENABLE
	//hs setting
...
static void epl_sensor_power(struct alsps_hw *hw, unsigned int on)
{
	...
	//modify@zte.com.cn remove at 20160118 begin
	/*
    //APS_LOG("power %s\n", on ? "on" : "off");
...
#endif
            //modify@zte.com.cn add 2060919 start
            //for init psensor
            epl_sensor_report_ps_status();
            //modify@zte.com.cn add 2060919 end
        }
        else
        {
...
MODULE_LICENSE("GPL");
//modify@zte.com.cn add at 20160115 end

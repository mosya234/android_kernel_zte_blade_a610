...
{0x51,1,{0xaf}},//C0
{0x60,1,{0x14}},//08 fae
{0xA0 ,1,{0x12}}, //1D modify@zte.com.cn modify at 20151020
{0xA1 ,1,{0x22}}, 
{0xA2 ,1,{0x2B}}, 
{0xA3 ,1,{0x0E}}, 
{0xA4 ,1,{0x10}}, 
...
{0xB2 ,1,{0x6B}}, 
{0xB3 ,1,{0x39}}, 
{0xC0 ,1,{0x12}}, //1D modify@zte.com.cn modify at 20151020
{0xC1 ,1,{0x2D}}, 
{0xC2 ,1,{0x38}}, 
{0xC3 ,1,{0x09}}, 
{0xC4 ,1,{0x0B}}, 
...
//{0xFF ,3,{0x98, 0x81, 0x05}},	 //modify@zte.com.cn add at 20151118
{REGFLAG_END_OF_TABLE, 0x00, {}}
};
#if 0
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.noncont_clock_period=2;
		...
		params->dsi.horizontal_sync_active				= 50;   //40 modify@zte.com.cn modify at 20151020
...
// To fix boot error
//modify@zte.com.cn modify at 20151012 begin
#ifdef CONFIG_WIND_PLL_CLOCK
		params->dsi.PLL_CLOCK = 215;	
#else
		params->dsi.PLL_CLOCK = 212;	   // 245;
#endif
//modify@zte.com.cn modify at 20151012 end
...
//modify@zte.com.cn modify at 20151118 begin
...
//modify@zte.com.cn modify at 20151118 end
}

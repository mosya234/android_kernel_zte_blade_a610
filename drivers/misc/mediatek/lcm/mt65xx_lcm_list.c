...
#include <mt-plat/mt_gpio.h>  //modify@zte.com.cn 20160527
#include <mach/gpio_const.h>  //modify@zte.com.cn 20160527
...
//modify@zte.com.cn 20160906 start
#if defined(ILI9881_HD720_DSI_VDO_YASSY_BOE_G5)
	&ili9881_hd720_dsi_vdo_yassy_boe_G5_lcm_drv,
#endif
//modify@zte.com.cn 20160906 end
//modify@zte.com.cn 20160801 start
#if defined(ILI9881_HD720_DSI_VDO_YASSY_BOE_E188F)
	&ili9881_hd720_dsi_vdo_yassy_boe_E188F_lcm_drv,
#endif
//modify@zte.com.cn 20160801 end
#if defined(HX8394F_HD720_DSI_VDO_BOE)
	&hx8394f_hd720_dsi_vdo_boe_lcm_drv,
#endif
//modify@zte.com.cn 20160603 begin
#if defined(HX8394F_HD720_DSI_VDO_TONGXINGDA)
	&hx8394f_hd720_dsi_vdo_tongxingda_lcm_drv,
#endif
//modify@zte.com.cn 20160603 end 
//modify@zte.com.cn 20160526 begin
#if defined(ILI9881_HD720_DSI_VDO_YASSY_HSD)
	&ili9881_hd720_dsi_vdo_yassy_hsd_lcm_drv,
#endif
//modify@zte.com.cn 20160526 end 
//modify@zte.com.cn  add at 20160408 begin
#if defined(ILI9881_HD720_DSI_VDO_YASSYCMI)
	&ili9881_hd720_dsi_vdo_yassycmi_lcm_drv,
#endif	
//modify@zte.com.cn  add at 20160408 end
//modify@zte.com.cn  add at 20160927 begin
#if defined(ILI9881_HD720_DSI_VDO_YASSYCMI_E181L)
	&ili9881_hd720_dsi_vdo_yassycmi_E181L_lcm_drv,
#endif	
//modify@zte.com.cn  add at 20160927 end
//modify@zte.com.cn 20160605 begin
#if defined(ILI9881_HD720_DSI_VDO_YASSY_BOE)
	&ili9881_hd720_dsi_vdo_yassy_boe_lcm_drv,
#endif
//modify@zte.com.cn 20160605 end 
#if defined(MTK_LCM_DEVICE_TREE_SUPPORT)
	&lcm_common_drv,
#else
//modify@zte.com.cn add at 20160310 begin
#if defined(OTM1287A_HD720_DSI_VDO_BY) 
	&otm1287a_hd720_dsi_vdo_by_lcm_drv,
#endif
//modify@zte.com.cn add at 20160310 end
//modify@zte.com.cn  add at 20160408 begin
#if defined(S6D7AAXO62_HD720_DSI_VDO_TIANMA) 
	&s6d7aaxo62_hd720_dsi_vdo_tianma_lcm_drv,
#endif
//modify@zte.com.cn  add at 20160408 end
//modify@zte.com.cn add at 20160510 begin
#if defined(ILI9881_HD720_DSI_VDO_YASSY_E169F)
	&ili9881_hd720_dsi_vdo_yassy_lcm_drv,
#endif
#if defined(NT35521S_HD720_DSI_VDO_TXD_E169F)
	&nt35521s_hd720_dsi_vdo_txd_lcm_drv,
#endif
#if defined(ILI9881_CA_HD720_DSI_VDO_YASSY_E169F)
	&ili9881_CA_hd720_dsi_vdo_yassy_lcm_drv,    
#endif
//modify@zte.com.cn add at 20160510 end
...
//add by modify@zte.com.cn 20150720 begin
//#if defined(GPIO_DISP_ID0_PIN)&&defined(GPIO_DISP_ID1_PIN)
#if 1
static unsigned char lcd_id_pins_value2 = 0xFF;
unsigned char which_lcd_module_triple_cust(void)
{

#if 1//defined(__SAME_IC_COMPATIBLE__)			
    unsigned char gpio_id1=0,gpio_id2=0;
    if(0xFF != lcd_id_pins_value2) 
    {
        return lcd_id_pins_value2;
    }
    mt_set_gpio_mode(GPIO_DISP_ID0_PIN,GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_DISP_ID0_PIN, GPIO_DIR_IN);
    gpio_id1 =  mt_get_gpio_in(GPIO_DISP_ID0_PIN);  // get signal
    mt_set_gpio_mode(GPIO_DISP_ID1_PIN,GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_DISP_ID1_PIN, GPIO_DIR_IN);
    gpio_id2 =  mt_get_gpio_in(GPIO_DISP_ID1_PIN);  // get signal
    
    lcd_id_pins_value2=gpio_id1<<4|gpio_id2;
	
#if defined(BUILD_LK)||defined(BUILD_UBOOT)
	printf("%s gpio_id1 =%d,gpio_id2=%d,lcd_id_pins_value2=%x\n",__func__,gpio_id1,gpio_id2,lcd_id_pins_value2);
#endif
	return lcd_id_pins_value2;
#else
	return 0;
...
#endif
//add by modify@zte.com.cn 20150720 end

/*
	modify@zte.com.cn 20160107 begin
*/
#ifndef _LENS_LIST_H
...
#endif
//modify@zte.com.cn 20160101 begin
...
#ifdef CONFIG_MTK_LENS_WV511BAF_SUPPORT
extern void WV511BAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long WV511BAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int WV511BAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//modify@zte.com.cn 20160509 begin
#ifdef CONFIG_MTK_LENS_BU64291AF_SUPPORT
extern void BU64291AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long BU64291AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int BU64291AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_BU64291BAF_SUPPORT
extern void BU64291BAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long BU64291BAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int BU64291BAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
//modify@zte.com.cn 20160509 end
//modify@zte.com.cn 20160101 end
#endif
/*

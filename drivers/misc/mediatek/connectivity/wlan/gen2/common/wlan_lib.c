...
//modify@zte.com.cn 201060514 begin
        #if defined(CONFIG_WIND_WIFI_FAST_SWITCH)
                        prAdapter->rWlanInfo.arPowerSaveMode[NETWORK_TYPE_P2P_INDEX].ucPsProfile =ENUM_PSP_FAST_SWITCH;
        #else
			//modify@zte.com.cn 201060413 begin
			prAdapter->rWlanInfo.arPowerSaveMode[NETWORK_TYPE_P2P_INDEX].ucPsProfile =ENUM_PSP_CONTINUOUS_ACTIVE;// ENUM_PSP_FAST_SWITCH;
			//modify@zte.com.cn 201060413 end
        #endif
//modify@zte.com.cn 201060514 end
#else

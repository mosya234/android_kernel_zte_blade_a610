...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x4837, 0x11);        //wupeiyuan
...
*************************************************************************/
	...
	static int read_otp_ov5670(struct otp_struct *otp_ptr)
	{
		...
		//LOG_INF("luminjie ov5670 otp_flag=%x\n",otp_flag);
		addr = 0;
		if((otp_flag & 0xc0) == 0x40) {
		...
		for(i=0x7010;i<=0x7029;i++) {
			...
			//otp_flag = read_cmos_sensor(i);
			//LOG_INF("luminjie ov5670 otp_flag=%x\n",otp_flag);
		}
		//set 0x5002[3] to ???1??ид
		temp1 = read_cmos_sensor(0x5002);
	...
	{
		//modify@zte.com.cn 20160329 begin
		int RG_Ratio_Typical = 0x148, BG_Ratio_Typical = 0x14f;
		//modify@zte.com.cn 20160329 end

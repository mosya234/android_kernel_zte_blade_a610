...
int _dsi_ps_type_to_bpp(LCM_PS_TYPE ps)
{
	...
	/*can't reach here */
	ASSERT(0);
	return -1; //modify@zte.com.cn modify
}
				    ...
				    LCM_DSI_PARAMS *dsi_params)
{
	...
	bool hstx_cklp_en =dsi_params->cont_clock?true:false; //modify@zte.com.cn modify at 20160413
	...
	switch(recv_data_cnt)
   	...
   	//		printk("tuwz 3 byte");
		...
		case 2:
				...
				if((read_data1.byte0==0x05&&read_data1.byte1==0x18)||(read_data1.byte0==0x0F&&read_data1.byte1==0xF0)||((read_data1.byte0 == dsi_params->lcm_esd_check_table[i].para_list[0]) && (read_data1.byte1 == dsi_params->lcm_esd_check_table[i].para_list[1])))

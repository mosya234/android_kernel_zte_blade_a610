...
#include<linux/delay.h> //modify@zte.com.cn add at 20140426
...
extern char mtkfb_lcm_name[256]; //modify@zte.com.cn add at 20160426
int disp_lcm_resume(disp_lcm_handle *plcm)
{
	...
	if (_is_lcm_inited(plcm)) {
		...
		//modify@zte.com.cn add at 20160426 begin
		if (!strcmp(mtkfb_lcm_name, "s6d7aaxo62_hd720_dsi_vdo_tianma"))
		{
			printk("s6d7aaxo62_hd720_dsi_vdo_tianma");
			msleep(50);
		}
		//modify@zte.com.cn add at 20160426 end
		return 0;
	}
